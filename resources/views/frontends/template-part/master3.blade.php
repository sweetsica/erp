<!DOCTYPE html>
<!-- saved from url=(0037)https://moitruongthudo.vn/?site_id=14 -->
<html lang="en"><!--<![endif]--><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">

    <meta content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no" name="viewport">
    <meta property="app_domain" content="">
    <title>Trang chủ | Cổng thông tin quan trắc môi trường thủ đô Hà Nội</title>
    <meta name="csrf_token" content="xueYeMLow6F9NCpQR0GF9PIvlftnUtnJnDDqO5eZ">

    <!-- ================== BEGIN BASE CSS STYLE ================== -->
    <link href=".//css" rel="stylesheet">
    <link href="{{asset('assets/files/bootstrap.min.css')}}" rel="stylesheet">
    <link rel="stylesheet" href="{{asset('assets/files/all.min.css')}}">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.12.1/css/all.min.css">

    <link href="{{asset('assets/files/flag-icon.css')}}" rel="stylesheet">
    <link href="{{asset('assets/files/animate.min.css')}}" rel="stylesheet">
    <link href="{{asset('assets/files/style.min.css')}}" rel="stylesheet">
    <link href="{{asset('assets/files/style-responsive.min.css')}}" rel="stylesheet">
    <link href="{{asset('assets/files/default.css')}}" id="theme" rel="stylesheet">

    <script src="{{asset('assets/files/leaflet.js')}}"></script>
    <script src="{{asset('assets/files/mapbox-gl.js')}}"></script>
    <script src="{{asset('assets/files/leaflet-mapbox-gl.js')}}"></script>
    <link rel="stylesheet" href="{{asset('assets/files/leaflet.css')}}">
    <link rel="stylesheet" href="{{asset('assets/files/mapbox-gl.css')}}">
    <link rel="stylesheet" href="{{asset('assets/files/flag-icon.min.css')}}" integrity="sha256-YjcCvXkdRVOucibC9I4mBS41lXPrWfqY2BnpskhZPnw=" crossorigin="anonymous">
    <link href="{{asset('assets/files/myapp.css')}}" rel="stylesheet">
    <style>
        .annoucementContent{
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('assets/files/chosen.css')}}">
    <style type="text/css">
                    ...
                    <div class="menu-wrapper float-left">
                        <nav id="mega-menu-holder" class="clearfix">
                            <ul class="clearfix">
                                ...
                                <li><a href="{{asset('assets/frontends/#')}}" style="padding-right: 20px;">Tin tức</a>
                                    <ul class="dropdown">
...
<script src="{{asset('assets/files/jquery-1.9.1.min.js')}}"></script>
<script src="{{asset('assets/files/bootstrap.min.js')}}"></script>
<script src="{{asset('assets/files/pace.min.js')}}"></script>
<script src="{{asset('assets/files/all.js')}}"></script>
<!-- ================== END BASE JS ================== -->

<script src="{{asset('assets/files/amcharts.js')}}"></script>
<script src="{{asset('assets/files/serial.js')}}"></script>
<script src="{{asset('assets/files/export.min.js')}}"></script>
<link rel="stylesheet" href="{{asset('assets/files/export.css')}}" type="text/css" media="all">
<script src="{{asset('assets/files/light.js')}}"></script>
<script src="{{asset('assets/files/ol.js')}}"></script>
<script src="{{asset('assets/files/jquery.timeago.js')}}"></script>
<script src="{{asset('assets/files/jquery.timeago.vi.js')}}"></script>
<script src="{{asset('assets/files/chosen.jquery.min.js')}}"></script>
<script src="{{asset('assets/files/jquery.slimscroll.min.js')}}"></script>
